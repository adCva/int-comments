...
import { addLike, substractLike } from "../Features/commentSlice";
...
function Likes(props) {
    ...
    const likePost = (id, nestedPost, nestedPostId) => {
            if (nestedPost) {
                ...
                dispatch(addLike({data: {comments: duplicateCommentsData}}));
                ...
                dispatch(substractLike({data: {comments: duplicateCommentsData}}));
            }
    };
